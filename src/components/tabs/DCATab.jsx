        ...
        <Card title="Paramètres" icon={Calculator}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: T.greenSoft, borderRadius: 8,
            }}>
